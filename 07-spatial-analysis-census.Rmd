...
```
Exploratory spatial data analysis relies on the concept of a _neighborhood_, which is a conceptualization of how a given geographic feature interrelates with other features nearby.  {spdep} supports a variety of neighborhood definitions.  These definitions include: 
...
## Issues with and other methods for exploratory spatial data analysis
