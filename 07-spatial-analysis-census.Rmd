...
![](images/paste-47AEF3CD.png){width="473"}
...
![](images/paste-79D3055A.png){width="100%"}
...
$$
I_i = \frac{(x_i-\bar{x})}{{\sum\limits_{k=1}^{n}(x_k-\bar{x})^2}/(n-1)}{\sum\limits_{j=1}^{n}w_{ij}(x_j-\bar{x})}
$$
...
knitr::include_app("https://walkerke.shinyapps.io/linked-brushing/", height = "400px")
```
