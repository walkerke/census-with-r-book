...
An alternative method for the calculation of local spatial autocorrelation is the local indicators of spatial association statistic, commonly referred to as LISA or the local form of Moran's *I* [@anselin2010].
...
Linked brushing (modify to use in an embedded Shiny app):

<iframe src="https://walkerke.shinyapps.io/linked-brushing/" width="100%" height="500" frameborder="0"></iframe>
