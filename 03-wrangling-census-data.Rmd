...
```{r az_race_percent_show, echo = FALSE}
...
### A warning: inconsistent variable IDs over time for the ACS Data Profile
...
style_data(co_college19, n_rows = 5, caption = "Variable DP02_0068P in 2019")
```
...
style_data(co_college18, n_rows = 5, caption = "Variable DP02_0068P in 2018")
```
...
We can examine values for a specific Census tract:
