...
<iframe src="img/leaflet/dallas_mapview.html" width="100%" height="400"></iframe>
...
<iframe src="img/leaflet/dallas_tmap.html" width="100%" height="400"></iframe>
...
<iframe src="img/leaflet/dallas_leaflet.html" width="100%" height="400"></iframe>
...
girafe(ggobj = vt_map + vt_plot, width_svg = 10, height_svg = 8) %>%
  girafe_options(opts_hover(css = "fill:cyan;"))
```

### Reactive mapping with Shiny

<iframe src="https://walkerke.shinyapps.io/msp-shiny-example/" width="100%" height="800" frameBorder="0"></iframe>
