...
`get_acs()` defaults to the most recent five-year ACS sample, which at the time of this writing is 2013-2017.  Different years and different surveys are available by adjusting the `endyear` and `survey` parameters.  For example, the following code will fetch data from the 1-year ACS for 2016: 
